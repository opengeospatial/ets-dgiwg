...
public class ExtendedSpatialFilterTest extends AbstractSpatialFilterTest {
    ...
    public Iterator<Object[]> spatialOperators()
    ...
    public
                    void spatialOperatorIsEnabled( ProtocolBinding binding, String spatialOperator ) {
        String xPathXml = String.format( "//wfs:WFS_Capabilities/fes:Filter_Capabilities/fes:Spatial_Capabilities/fes:SpatialOperators/fes:SpatialOperator[@name='%s']",
                                         spatialOperator );
